...
const generateResponse = (lowerMsg, originalMsg) => {
	// Assessment related
	if (lowerMsg.includes("assessment") || lowerMsg.includes("report")) {
		...
		if (lowerMsg.includes("export") || lowerMsg.includes("download") || lowerMsg.includes("pdf") || lowerMsg.includes("word")) {
		...
		if (lowerMsg.includes("version") || lowerMsg.includes("restore") || lowerMsg.includes("history")) {
	...
	if (lowerMsg.includes("workspace") || lowerMsg.includes("project") || lowerMsg.includes("folder")) {
	...
	if (lowerMsg.includes("assistant") || lowerMsg.includes("chat") || lowerMsg.includes("ai ")) {
		...
		if (lowerMsg.includes("tone") || lowerMsg.includes("translate") || lowerMsg.includes("grammar") || lowerMsg.includes("writing")) {
	...
	if (lowerMsg.includes("plan") || lowerMsg.includes("billing") || lowerMsg.includes("price") || lowerMsg.includes("pricing") || lowerMsg.includes("subscription") || lowerMsg.includes("upgrade") || lowerMsg.includes("cost")) {
	...
	// Knowledge base
	if (lowerMsg.includes("knowledge") || lowerMsg.includes("rag") || lowerMsg.includes("upload") || lowerMsg.includes("document")) {
	...
	if (lowerMsg.includes("playbook") || lowerMsg.includes("sitemap") || lowerMsg.includes("wireframe")) {
	...
	// Keyboard / shortcuts
	if (lowerMsg.includes("shortcut") || lowerMsg.includes("ctrl") || lowerMsg.includes("keyboard") || lowerMsg.includes("command palette")) {
	...
	// Trash
	if (lowerMsg.includes("trash") || lowerMsg.includes("deleted") || lowerMsg.includes("recover") || lowerMsg.includes("restore")) {
	...
	if (lowerMsg.includes("team") || lowerMsg.includes("collaborate") || lowerMsg.includes("invite") || lowerMsg.includes("share")) {
	...
	// Feedback
	if (lowerMsg.includes("feedback") || lowerMsg.includes("suggestion") || lowerMsg.includes("bug")) {
