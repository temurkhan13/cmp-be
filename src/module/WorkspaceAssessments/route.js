...
router
  ...
  .post(
    auth(),
    validate(validation.createWorkspaceAssessment),
    controller.createWorkspaceAssessment
  )
...
router
  ...
  .patch(
    auth(),
    validate(validation.updateWorkspaceAssessment),
    controller.updateWorkspaceAssessment
  )
  .delete(
    auth(),
    validate(validation.deleteWorkspaceAssessment),
    controller.deleteWorkspaceAssessment
  );
